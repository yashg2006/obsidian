                    ...
                    <button
                        ...
                        onClick={() => {
                            const newPlanet = {
                                ...
                                description: `A ${simulatorParams.planetRadius > 1.5 ? 'massive' : 'rocky'} world discovered with ${habitabilityScore}% habitability via Simulator.`,
                                color: '#00f0ff',
                            ...
                            alert(`Planet ${newPlanet.name} archived successfully to your Personal and Global catalogs!`);
                        }}
                    >
