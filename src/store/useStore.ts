...
interface AppState {
    ...
    addPlanetToExplore: (planet: Planet) => void;
}
...
export const useStore = create<AppState>((set, get) => ({
    ...
    loginAsGuest: () => {
        set({
            user: { id: 'guest', email: 'guest@cosmos.app', name: 'Explorer' },
    ...
    logout: () => {
        ...
        set({ user: null, isAuthenticated: false, isGuest: false, savedPlanets: [] });
    },
    ...
    addPlanetToExplore: (planet) => {
        set((state) => ({ allPlanets: [planet, ...state.allPlanets] }));
    },
}));
